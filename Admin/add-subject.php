...
$sql = "SELECT * FROM tblsubject where subject='$subject'";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
$_SESSION['error']=' subject already Registered ';
}else{


//save subject details
$query = "INSERT into `tblsubject` (subject)
VALUES ('$subject')";
...
<head>
  ...
  <title>Add Subject|Dashboard</title>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                                         <?php 
                                          $sql = "SELECT * FROM tblsubject order by subject";
                                           $result = $conn->query($sql); 
										$cnt=1;
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <a class="dropdown-item" href="delete-subject.php?id=<?php echo $row['ID'];?>" onClick="return deldata();">Delete</a>
                                           <a class="dropdown-item" href="delete-subject.php?id=<?php echo $row['ID'];?>" onClick="return deldata();">Delete</a>
