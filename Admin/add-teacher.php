...
$_SESSION['error']=' Teacher already Registered ';
}else{
...
$teacherID = randomID();
//save users details
$query = "INSERT into `tblteacher` (teacherID,fullname,password,sex,email,date_reg,status,photo)
VALUES ('$teacherID','$fullname','$password','$sex','$email','$current_date','1','uploadImage/default.jpg')";
...
$_SESSION['success'] ='Teacher Added Successfully';
  ...
  $_SESSION['error'] ='Problem Adding Teacher';
}
}
}
...
<head>
  ...
  <title>Add Teacher|Dashboard</title>
...
return  true;
  ...
  <script type="text/javascript">
		function deldata(){
if(confirm("ARE YOU SURE YOU WISH TO DELETE THIS TEACHER ?" ))
{
return  true;
}
else {return false;
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Teacher Record</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tr> <th width="3%"><div align="center">#</div></th>
                        ...
                        <th width="13%"><div align="center">Teacher ID</div></th>
                    ...
                    <tbody>
                                         <?php 
                                          $sql = "SELECT * FROM tblteacher order by date_reg ASC";
                                           $result = $conn->query($sql); 
										$cnt=1;
					  ...
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['teacherID']; ?></div></td>
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <a class="dropdown-item" href="delete-teacher.php?id=<?php echo $row['ID'];?>" onClick="return deldata();">Delete</a>
                      <?php if (($row['status'])==(('1')))  { ?>
                      <a class="dropdown-item" href="block-unblock-teacher.php?id=<?php echo $row['ID'];?>" onClick="return Deactivate('<?php echo $row['fullname']; ?> ');">Deactivate</a>
					  <?php } else {?>
					  <a class="dropdown-item" href="block-unblock-teacher.php?uid=<?php echo $row['ID'];?>" onClick="return Activate('<?php echo $row['fullname']; ?> ');">Activate</a>
					  <?php } ?>
                    </div>
                  </div>
                </td>
