...
<title>Teacher Dashboard |<?php echo $website_name ;?> </title>
...
?>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                              <h5><span class="label label-primary pull-right">Teacher ID </span>
</h5>
                            </div>
							
                            <div class="ibox-content">
                                <h3 class="no-margins"><?php echo $teacherID; ?> </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>          
                 ...
                 $query = "SELECT * FROM tblsubjectallocation where teacherID='$ID' "; 
                 ...
                 ?>
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                              <h5><span class="label label-warning pull-right">No of Allocated Subject </span>
</h5>
                            </div>
							
                            <div class="ibox-content">
                                <h3 class="no-margins"><?php echo $row_subjects; ?> </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>  
