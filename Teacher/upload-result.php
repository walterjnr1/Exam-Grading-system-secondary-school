...
$term_1 = mysqli_real_escape_string($conn,$_POST['cmdterm']);
$class = mysqli_real_escape_string($conn,$_POST['cmdclass']);
$arm = mysqli_real_escape_string($conn,$_POST['cmdarm']);
$classarm_1=$class.$arm;



//check if result already published
$sql = "SELECT * FROM tblresultsummary where school_session='$currentsession' and term='$term_1' and class_arm='$classarm_1'";
