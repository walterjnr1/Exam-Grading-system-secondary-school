...
$rowaccess = mysqli_fetch_array($result);
 ...
 if(isset($_POST["btnedit"])){
  ...
  $class_arm=$_POST['txtclass'].$_POST['txtarm'];

   $sql = "update  tblstudent set fullname='".$_POST['txtfullname']."',sex='".$_POST['cmdsex']."',phone='".$_POST['txtphone']."',address='".$_POST['txtaddress']."',state='".$_POST['cmdstate']."',class='".$_POST['txtclass']."',arm='".$_POST['txtarm']."',class_arm='$class_arm' where admissionID= '$admissionID'";
...
<span class="m-r-sm text-muted welcome-message">Welcome to <?php echo $rowaccess['fullname'];?></span>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
          ...
          <option value="Female">Female</option>
                                    ...
                                    <input type="text" name="txtphone" value="<?php echo $rowaccess['phone']; ?>"  class="form-control" required="">
                                    </div>
                                    <div class="form-group"><strong>
                                    <label>Address</label></strong>
                                    <input type="text" name="txtaddress" value="<?php echo $rowaccess['address']; ?>"  class="form-control" required="">
                                    </div>
                                    <div class="form-group"><strong>
                               ...
                               <option value="South">South</option>
	                        	...
	                        	<p>   </p>
                                    ...
                                    <input type="text" name="txtclass" value="<?php echo $rowaccess['class']; ?>"  class="form-control" required="">
                                    </div>
                                    <div class="form-group"><strong>
                                    <label>Arm</label></strong>
                                    <input type="text" name="txtarm" value="<?php echo $rowaccess['arm']; ?>"  class="form-control" required="">
                                    </div>
