...
//$last_login = 'Not Available';
 ...
 $query = "
 INSERT INTO tblstudent (admissionID,fullname,password, sex, phone, address,state,class,arm,class_arm,status,date_reg,photo) VALUES (:admissionID, :fullname, :password,:sex, :phone,:address,:state,:class,:arm,:class_arm,:status,:date_reg,:photo)";
 ...
 $message = ' <div class="alert alert-success">Student Registration Was successful...  Admission Number Will be provided by Admin  </div> ';
  } else {
           ...
           <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">                        
                      <p ><a href="index.php"><span class="logos"><img class="logo-size" src="<?php echo $logo; ?>" alt="logo" height="110" width="290"></span></a></p>
                      <h3><?php echo $website_name ;?> -Student Registration Form</h3>
                        <p>&nbsp;</p>
                        <p> <h4 ><?php echo $message; ?></h4> </p>
                        <div class="page-links">
						<a href="index.php" >Student Login</a><a href="register.php" class="active">Student Registration</a><a href="teacher.php">Teacher </a><a href="admin.php">Admin </a>
                        </div>
